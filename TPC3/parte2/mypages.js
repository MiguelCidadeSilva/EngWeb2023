...
<html>
    ...
    <body>
            <div class="w3-container">
                <a href="http://localhost:7777" class="w3-btn w3-red">Voltar</a>
            </div>
        <div class="w3-card-4">
...
<html>
    ...
    pagHtml += `
        ...
        <div class="w3-container">
            <a href="http://localhost:7777/pessoas" class="w3-btn w3-red">Voltar</a>
        </div>
    </body>
</html>
    `
...
exports.paginaSexo = function(lista,date)
{
    ...
    <html>
        ...
        pagHtml+= `
            ...
            <div class="w3-container">
                <a href="http://localhost:7777" class="w3-btn w3-pink">Voltar</a>
            </div> 
        </body>
    </html>
        `
...
exports.paginaDesportos = function(lista,date)
{
    ...
    <html>
        ...
        <body>
        <div class="w3-container">
                <a href="http://localhost:7777" class="w3-btn w3-blue">Voltar</a>
            </div>
            <div class="w3-card-4">
...
exports.getProfissoes = function(lista,date)
{
    ...
    <html>
        ...
        pagHtml+= `
            ...
            <div class="w3-container">
                <a href="http://localhost:7777" class="w3-btn w3-yellow">Voltar</a>
            </div> 
        </body>
    </html>
        `
